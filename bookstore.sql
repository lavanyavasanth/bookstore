...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2018 at 01:37 PM
...
(11, 'jhjhj', 'kkh', 4898, 'jjk', 45, 'njhj', 'andThenThereWereNone.jpg', 11),
(12, 'jwhfku', 'hfwj', 0, 'hdf', 0, 'fhkja', 'redChamber.jpg', 12),
...
--
ALTER TABLE `author`
  MODIFY `AuthorID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `booklog`
  MODIFY `BooklogID` int(10) NOT NULL AUTO_INCREMENT;
